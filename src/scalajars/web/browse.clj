(ns scalajars.web.browse
  (:require [scalajars.web.common :refer [html-doc jar-link user-link format-date
                                        page-nav page-description jar-name
                                        collection-fork-notice]]
            [scalajars.db :refer [browse-projects count-all-projects
